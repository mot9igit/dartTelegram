...
class dartTelegramLevelUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('darttelegram_level_err_ns');
        }
...
return 'dartTelegramLevelUpdateProcessor';
